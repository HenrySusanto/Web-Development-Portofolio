...
<?php
  ...
  if(isset($_POST['Edit']))
  {
    ...
    mysqli_query($connection,"update restoran set restonama='$namaresto',areaID='$kodearea'
  ...
  // untuk menampilkan data pada form edit 
   $koderesto = $_GET["ubah"];
   $editresto = mysqli_query($connection,"SELECT * FROM restoran WHERE restoID = '$koderesto'");
   $rowedit = mysqli_fetch_array($editresto);

   $editarea = mysqli_query($connection,"SELECT * FROM restoran,area
    WHERE restoID = '$koderesto' and restoran.areaID = area.areaID");
