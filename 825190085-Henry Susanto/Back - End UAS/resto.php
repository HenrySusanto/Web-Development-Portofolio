...
<?php
  ...
  if(isset($_POST['Simpan']))
  {
  	...
  	{
  		$restokode = $_REQUEST['inputkode'];
  	}
 	if (!empty($restokode))
 	{
 		$restokode = $_POST['inputkode'];
 	}
     ...
     mysqli_query($connection,"insert into restoran values('$restokode','$namaresto','$kodearea')");
...
<div class="row">
 ...
 <form method="POST">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="Text" class="form-control" id="kodedestinasi" name= "inputkode" placeholder="Kode Restoran" maxlength="4">
    </div>
  </div>

  <div class="form-group row">
    <label for="namadestinasi" class="col-sm-2 col-form-label">Nama Restoran</label>
    <div class="col-sm-10">
      <input type="Text" class="form-control" id="namadestinasi" name ="inputnama"  placeholder="Nama Restoran">
    </div> 
  </div>
		...
		<div class="col-sm-10">
			<div class="jumbotron jumbotron-fluid">
				<div class="container">
					...
					<h2> Hasil Entry Data Pada Tabel restoran </h2>
				</div>
			</div> <!-- penutup jumbotron-->
...
<!-- memulai menampilkan data -->
	<form method="POST">
		<div class="form-group row mb-2">
			...
			<div class="col-sm-6">
				<input type="text" name="search" class="form-control" id="search" value="<?php if(isset($_POST['search'])) {echo $_POST['search'];}?>" placeholder="Cari Nama Restoran">
			</div>
 ...
 <!-- untuk icon edit dan delete -->
     <td>
      <a href="restoedit.php?ubah=<?php echo $row["restoID"]?>" 
    ...
    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil-square" fill="currentColor"   xmlns="http://www.w3.org/2000/svg">
      ...
      <td>
         <a href="restohapus.php?hapus=<?php echo $row["restoID"]?>" 
