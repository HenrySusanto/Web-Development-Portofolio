...
<body>
	...
	<div class="col-sm-10">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="kodefoto" name="inputkode" value="<?php 
				echo $rowedit["fotoID"]?>" readonly>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="namafoto" name="inputnama" value="<?php 
				echo $rowedit["fotonama"]?>"  >
			</div>
		</div>
			...
			{?>
				...
				<tr>
					...
					<td>
						...
						<?php }else echo"<img src ='images/noimage.png'width= '80'>"
					...
					<td>
						<a href="photodestinasiubah.php?ubahfoto=<?php echo $row[
