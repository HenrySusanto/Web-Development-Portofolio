...
<?php
  ...
  if(isset($_POST['Simpan']))
  {
     ...
     mysqli_query($connection,"insert into objekwisata values('$objekkode','$namaobjek','$kodeobjek')");
...
<div class="row">
 ...
 <form method="POST">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="Text" class="form-control" id="kodedestinasi" name= "inputkode" placeholder="Kode objek wisata" maxlength="4">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="Text" class="form-control" id="namadestinasi" name ="inputnama"  placeholder="Nama Objek Wisata">
    </div> 
  </div>
