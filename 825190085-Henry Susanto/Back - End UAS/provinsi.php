...
<div class="row">
 ...
 <form method="POST">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="Text" class="form-control" id="kodedestinasi" name= "inputkode" placeholder="Kode Provinsi" maxlength="4">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="Text" class="form-control" id="area" name ="inputnama"  placeholder="Nama Provinsi">
    </div> 
  </div>
  ...
  <div class="col-sm-10">
   <input type="Text" class="form-control" id="wilarea" name = "wilarea" placeholder="Tanggal Berdiri Format/YYYY-MM-DD ">
</div>
  </div>
...
<!-- memulai menampilkan data -->
	...
	$query = mysqli_query($connection, "select provinsi.*, provinsi.provinsiID,provinsi.provinsinama 
      from provinsi
      where provinsi.provinsiID = provinsi.provinsiID");
  }
	$nomor = 1;
