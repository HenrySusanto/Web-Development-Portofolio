...
<?php
  ...
  if(isset($_POST['Edit']))
  {
     ...
     mysqli_query($connection,"update area  set destinasinama='$destinasinama',areawilayah='$wilayaharea ',areaketerangan='$areaketerangan',areanama='$provinsiID'
      where areaID ='$destinasikode'");
...
// untuk menampilkan data pada form edit 
  ...
  $editkategori = mysqli_query($connection,"SELECT * 
    FROM area, provinsi
    WHERE areaID = '$areakode' and area.povinsiID = provinsi.provinsiID"); 
...
<div class="row">
 ...
 <form method="POST">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="Text" class="form-control" id="kodedestinasi" name= "inputkode" value="<?php echo $rowedit["areaID"]?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="Text" class="form-control" id="area" name ="inputnama"  value="<?php echo $rowedit["areanama"]?>">
    </div> 
  </div>
  ...
  <div class="col-sm-10">
   ...
   <option value="<?php echo $rowedit['areawilayah']?>"><?php echo $rowedit['areawilayah']?></option>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="Text" class="form-control" id="areket" name = "areket" value="<?php echo $rowedit["areaketerangan"]?>">
    </div>
  </div>
  ...
  <option value="<?php echo $rowedit['povinsiID']?>"><?php echo $rowedit['povinsiID']?></option>
...
<!-- memulai menampilkan data -->
	...
	$query = mysqli_query($connection, "select area.*, area.areaID,area.areanama,provinsi.provinsiID,provinsi.provinsinama 
      from area,provinsi
      where area.povinsiID = provinsi.provinsiID");
  }
	$nomor = 1;
