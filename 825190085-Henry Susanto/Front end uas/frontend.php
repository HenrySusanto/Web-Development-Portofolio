...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-none d-md-block">
        <h1>Pemandangan Hutan Siluet</h1>
        <p>Hutan yang bersinar cahaya matahari</p>
      </div>
    </div>
  </div>
...
<div class="container1">
  ...
  <li class="media">
    ...
    <div class="media-body">
     ...
     <p>Tempat wisata di sleman cocok buat kamu yang ingin mendapatkan suasana dan foto yang indah <a href="sleman.php">Read More</a></p>
    </div>
  </li>
  <li class="media my-4">
    ...
    <div class="media-body">
      ...
      <p>Tour de Merapi yang awalnya diselengarakan setiap dua tahunan ini dijadikan ajang tahunan karena antusiasme peserta yang membludak <a href="merapi.php">Read More</a></p>
    </div>
  </li>
  <li class="media">
    ...
    <div class="media-body">
     ...
     <p> Onde-Onde ikan Nila menjadi jajanan oleh-oleh baru bagi wisatawan yang sedang berkunjung ke Sleman <a href="camilan.php">Read More</a></p>
    </div>
  </li>
</ul>
...
<div class="kanan">
  <h3>Video Pesona Jawa Tengah</h3>
  <iframe width="450" height="315" src="https://www.youtube.com/embed/NV1Ux31_nkU" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

  <h5>source : Visit Jawa Tengah</h5>
</div>
      </div>
    </div>
  </div>
